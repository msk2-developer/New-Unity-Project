...
public class SaveData : MonoBehaviour {
	...
	// 所持ペット情報クラス
	private static List<PetData> myPetDataList;
//	// 選択ペット情報クラス
//	private static List<SelectedPetData> selectedPetDataList;
	// 選択ペット情報まとめクラス
	private static List<SelPetJoinAllPetData> selPetJoinAllPetDataList;
	...
	void Start () {
		...
		userData = ds.GetUserData ();
		myPetDataList = ds.GetAllMyPetData ();
		selPetJoinAllPetDataList = ds.GetSelPetJoinAllPetData ();
//		foreach(SelPetJoinAllPetData c in selPetJoinAllPetDataList){
//			SelectedPetData selectedPetData = new SelectedPetData ();
//			selectedPetData.sortnum = c.sortnum;
//			selectedPetData.petid = c.petid;
//			selectedPetDataList.Add (selectedPetData);
//		}
	}
	...
	// ユーザ情報クラス setter
	public static void SetUserData(UserData setUserData) {
		userData = setUserData;
	}

	// ペット情報クラス getter
	public static List<PetData> GetMyPetDataList() {
		return myPetDataList;
	}
	// ペット情報クラス setter
	public static void SetMyPetDataList(List<PetData> setMyPetDataList) {
		myPetDataList = setMyPetDataList;
	}

//	// 選択ペット情報クラス getter
//	public static List<SelectedPetData> GetSelectedPetDataList() {
//		return selectedPetDataList;
//	}
//	// 選択ペット情報クラス setter
//	public static void SetSelectedPetDataList(List<SelectedPetData> setSelectedPetDataList) {
//		selectedPetDataList = setSelectedPetDataList;
//	}

	// 選択ペット情報クラス getter
	public static List<SelPetJoinAllPetData> GetSelPetJoinAllPetDataList() {
		return selPetJoinAllPetDataList;
	}
	// 選択ペット情報クラス setter
	public static void SetSelPetJoinAllPetDataList(List<SelPetJoinAllPetData> setSelPetJoinAllPetDataList) {
		selPetJoinAllPetDataList = setSelPetJoinAllPetDataList;
	}
